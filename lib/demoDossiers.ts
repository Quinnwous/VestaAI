...
export const DEMO_DOSSIERS: DemoDossierDefinitie[] = [
  // ── Verkoopadvies (5) — nog geen content, alleen waardering/advies ──────
  {
    ...
    input: { adres: 'Kerkehoutlaan 12, Wassenaar', woningtype: 'Villa', kamers: 7, oppervlak_m2: 285, bouwjaar: 1998, energielabel: 'B', prijsverwachting_verkoper: 2450000, usps: 'Vrijstaande villa op ruim perceel · dubbele garage · zonnig aangelegde tuin op het zuidwesten', doelgroep: 'Gezinnen met kinderen', taal: 'nl' },
    metContent: false, buurtomschrijving: '',
  },
  {
    address: 'Deijlerweg 45, Wassenaar', plaats: 'Wassenaar', lat: 52.1358, lng: 4.3847,
    fase: 'verkoopadvies', status: 'draft',
    input: { adres: 'Deijlerweg 45, Wassenaar', woningtype: 'Vrijstaand', kamers: 6, oppervlak_m2: 210, bouwjaar: 1975, energielabel: 'C', prijsverwachting_verkoper: 1595000, usps: 'Karakteristieke jaren-70-woning · veel privacy · nabij Landgoed Backershagen', doelgroep: 'Doorstromers', taal: 'nl', ligging_buitenruimte: { ligging: 'twee_onder_een_kap' } },
    metContent: false, buurtomschrijving: '',
  },
  {
    address: 'Van Alkemadelaan 88, Den Haag', plaats: "'s-Gravenhage", lat: 52.0992, lng: 4.3238,
    fase: 'verkoopadvies', status: 'draft',
    input: { adres: 'Van Alkemadelaan 88, Den Haag', woningtype: 'Appartement', kamers: 3, oppervlak_m2: 110, bouwjaar: 1962, energielabel: 'D', prijsverwachting_verkoper: 545000, usps: 'Ruim hoekappartement · uitzicht over het Haagse Bos · eigen berging', doelgroep: 'Young professionals', taal: 'nl' },
    metContent: false, buurtomschrijving: '',
  },
  {
    address: 'Leidseweg 21, Voorschoten', plaats: 'Voorschoten', lat: 52.1249, lng: 4.4472,
    fase: 'verkoopadvies', status: 'draft',
    input: { adres: 'Leidseweg 21, Voorschoten', woningtype: 'Tussenwoning', kamers: 5, oppervlak_m2: 135, bouwjaar: 1955, energielabel: 'D', prijsverwachting_verkoper: 685000, usps: 'Dorpse ligging · verbouwde keuken · fietsafstand van station Voorschoten', doelgroep: 'Gezinnen met kinderen', taal: 'nl' },
    metContent: false, buurtomschrijving: '',
  },
  {
    address: 'Damlaan 7, Leidschendam', plaats: 'Leidschendam', lat: 52.0841, lng: 4.4009,
    fase: 'verkoopadvies', status: 'draft',
    input: { adres: 'Damlaan 7, Leidschendam', woningtype: 'Appartement', kamers: 3, oppervlak_m2: 92, bouwjaar: 2005, energielabel: 'A', prijsverwachting_verkoper: 425000, usps: 'Modern appartement aan de Vliet · balkon op het zuiden · eigen parkeerplaats', doelgroep: 'Starters', taal: 'nl' },
    metContent: false, buurtomschrijving: '',
  },
  // ── In verkoop (5, waarvan 2 met content) ───────────────────────────────
  {
    ...
    input: { adres: "Storm van 's-Gravesandeweg 3, Wassenaar", woningtype: 'Villa', kamers: 8, oppervlak_m2: 340, bouwjaar: 2010, energielabel: 'A+', vraagprijs: 3200000, prijsverwachting_verkoper: 3200000, usps: 'Moderne villa in de duinzone · thuisbioscoop · verwarmd buitenzwembad', doelgroep: 'Vermogende gezinnen', taal: 'nl' },
  ...
  },
  {
    ...
    input: { adres: 'Nassaulaan 56, Den Haag', woningtype: 'Appartement', kamers: 4, oppervlak_m2: 145, bouwjaar: 1920, energielabel: 'C', vraagprijs: 795000, prijsverwachting_verkoper: 795000, usps: 'Statig herenhuisappartement · originele details · loopafstand van het strand', doelgroep: 'Doorstromers', taal: 'nl' },
  ...
  },
  {
    ...
    fase: 'in_verkoop', status: 'published',
    input: { adres: 'Haagweg 102, Rijswijk', woningtype: 'Hoekwoning', kamers: 5, oppervlak_m2: 128, bouwjaar: 1988, energielabel: 'B', vraagprijs: 549000, prijsverwachting_verkoper: 549000, usps: 'Hoekwoning met ruime tuin · dichtbij station Rijswijk · goed onderhouden', doelgroep: 'Gezinnen met kinderen', taal: 'nl' },
    metContent: false, buurtomschrijving: '',
  },
  {
    address: 'Langstraat 9, Wassenaar', plaats: 'Wassenaar', lat: 52.1414, lng: 4.4024,
    fase: 'in_verkoop', status: 'published',
    input: { adres: 'Langstraat 9, Wassenaar', woningtype: 'Tussenwoning', kamers: 4, oppervlak_m2: 118, bouwjaar: 1932, energielabel: 'D', vraagprijs: 725000, prijsverwachting_verkoper: 725000, usps: 'Karakteristieke woning in het centrum · op loopafstand van winkels en station', doelgroep: 'Doorstromers', taal: 'nl' },
    metContent: false, buurtomschrijving: '',
  },
  {
    address: 'Rembrandtlaan 14, Voorschoten', plaats: 'Voorschoten', lat: 52.1251, lng: 4.4479,
    fase: 'in_verkoop', status: 'onder_bod',
    input: { adres: 'Rembrandtlaan 14, Voorschoten', woningtype: 'Vrijstaand', kamers: 6, oppervlak_m2: 175, bouwjaar: 1968, energielabel: 'C', vraagprijs: 1095000, prijsverwachting_verkoper: 1095000, usps: 'Twee-onder-een-kapwoning · grote achtertuin op het zuiden · garage', doelgroep: 'Gezinnen met kinderen', taal: 'nl', ligging_buitenruimte: { ligging: 'twee_onder_een_kap' } },
    metContent: false, buurtomschrijving: '',
  },
  // ── Verkocht (5, waarvan 2 met content) ─────────────────────────────────
  {
    ...
    input: { adres: 'Bankastraat 33, Den Haag', woningtype: 'Appartement', kamers: 3, oppervlak_m2: 98, bouwjaar: 1925, energielabel: 'C', vraagprijs: 465000, prijsverwachting_verkoper: 465000, usps: 'Lichte bovenwoning in de Archipelbuurt · dakterras · nabij Vredespaleis', doelgroep: 'Young professionals', taal: 'nl' },
  ...
  },
  {
    ...
    fase: 'verkocht', status: 'verkocht',
    input: { adres: 'Rust en Vreugdlaan 5, Wassenaar', woningtype: 'Villa', kamers: 7, oppervlak_m2: 260, bouwjaar: 2001, energielabel: 'A', vraagprijs: 2150000, prijsverwachting_verkoper: 2150000, usps: 'Vrijstaande villa in Kerkehout · privétuin met poolhouse · dubbele oprit', doelgroep: 'Vermogende gezinnen', taal: 'nl' },
  ...
  },
  {
    ...
    fase: 'verkocht', status: 'verkocht',
    input: { adres: 'Vlietweg 18, Leidschendam', woningtype: 'Vrijstaand', kamers: 5, oppervlak_m2: 155, bouwjaar: 1980, energielabel: 'C', vraagprijs: 875000, prijsverwachting_verkoper: 875000, usps: 'Twee-onder-een-kapwoning aan de Vliet · eigen aanlegsteiger', doelgroep: 'Doorstromers', taal: 'nl', ligging_buitenruimte: { ligging: 'twee_onder_een_kap' } },
    metContent: false, buurtomschrijving: '',
  },
  {
    address: 'Beresteinlaan 210, Den Haag', plaats: "'s-Gravenhage", lat: 52.0894, lng: 4.3483,
    fase: 'verkocht', status: 'verkocht',
    input: { adres: 'Beresteinlaan 210, Den Haag', woningtype: 'Appartement', kamers: 3, oppervlak_m2: 78, bouwjaar: 1972, energielabel: 'D', vraagprijs: 335000, prijsverwachting_verkoper: 335000, usps: 'Instapklaar appartement · nabij winkelcentrum Leyweg · goede OV-verbinding', doelgroep: 'Starters', taal: 'nl' },
    metContent: false, buurtomschrijving: '',
  },
  {
    address: 'Generaal Spoorlaan 44, Rijswijk', plaats: 'Rijswijk', lat: 52.0395, lng: 4.3374,
    fase: 'verkocht', status: 'verkocht',
    input: { adres: 'Generaal Spoorlaan 44, Rijswijk', woningtype: 'Hoekwoning', kamers: 4, oppervlak_m2: 112, bouwjaar: 1965, energielabel: 'D', vraagprijs: 495000, prijsverwachting_verkoper: 495000, usps: 'Hoekwoning met berging · rustige straat · vlakbij Te Werve-park', doelgroep: 'Starters', taal: 'nl' },
    metContent: false, buurtomschrijving: '',
  },
]
