...
| Geen pitch-concept | De opdracht is zo goed als binnen zodra het verkoopadvies op papier staat; er zijn geen gewonnen of verloren pitches. Winratio, `PitchScorebord`, pitch-uitslag en alle "pitch"-teksten verdwijnen (item 1.9c; kolom vervalt in 2.1). Fase Acquisitie blijft als naam voor "verkoopadvies in voorbereiding" — hernoemen naar "Verkoopadvies" is een open suggestie voor Quinn, niet besloten | Quinn |
