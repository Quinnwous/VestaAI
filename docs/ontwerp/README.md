...
| `startpagina.html` | Dashboard + dossierheader (2.5, 3.4, 10.2) — banner (teamfoto-placeholder neutraal), kerncijfers met hero, recent bekeken, deze week; dossierheader met fasestepper, waarde/content-blok, tabs; ⚠️ nog bij te werken in item 0.1: snelkoppelingen, winratio en pitch-uitslag eruit, fase "Acquisitie" → "Verkoopadvies" (besluiten 17 sep), topbar plat; staten laden/weinig data/nieuw kantoor/in verkoop/verkocht/zonder foto | klaar (17 sep, Sonnet gebouwd, Fable AKKOORD na 1 ronde) |
